...
public class JedisTest {
    ...
    public void testPool() {
       ...
       4. 关闭资源
        */
        JedisPool jedisPool = new JedisPool("192.168.1.40", 6379);
    ...
    public void testCluster() {
        ...
        nodes.add(new HostAndPort("192.168.1.40", 7001));
        nodes.add(new HostAndPort("192.168.1.40", 7002));
        nodes.add(new HostAndPort("192.168.1.40", 7003));
        nodes.add(new HostAndPort("192.168.1.40", 7004));
        nodes.add(new HostAndPort("192.168.1.40", 7005));
        nodes.add(new HostAndPort("192.168.1.40", 7006));
